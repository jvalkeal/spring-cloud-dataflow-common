 ...
 */
package org.springframework.cloud.dataflow.common.security.legacy;
...
import org.springframework.cloud.dataflow.common.security.support.AccessTokenClearingLogoutSuccessHandler;
import org.springframework.cloud.dataflow.common.security.support.AuthoritiesMapper;
import org.springframework.cloud.dataflow.common.security.support.ConditionalOnIdentityProvider;
import org.springframework.cloud.dataflow.common.security.support.CustomAuthoritiesOpaqueTokenIntrospector;
import org.springframework.cloud.dataflow.common.security.support.CustomOAuth2OidcUserService;
import org.springframework.cloud.dataflow.common.security.support.CustomPlainOAuth2UserService;
import org.springframework.cloud.dataflow.common.security.support.DefaultAuthoritiesMapper;
import org.springframework.cloud.dataflow.common.security.support.DefaultOAuth2TokenUtilsService;
import org.springframework.cloud.dataflow.common.security.support.ExternalOauth2ResourceAuthoritiesMapper;
import org.springframework.cloud.dataflow.common.security.support.ManualOAuthAuthenticationProvider;
import org.springframework.cloud.dataflow.common.security.support.MappingJwtGrantedAuthoritiesConverter;
import org.springframework.cloud.dataflow.common.security.support.OAuth2TokenUtilsService;
...
@EnableWebSecurity
@ConditionalOnIdentityProvider(type = ConditionalOnIdentityProvider.Type.LEGACY)
public class LegacyOAuthSecurityConfiguration extends WebSecurityConfigurerAdapter {

	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(LegacyOAuthSecurityConfiguration.class);
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		String[] authenticatedPaths = Stream
			.concat(this.authorizationProperties.getAuthenticatedPaths().stream(),
					Stream.of("/", dashboard("/**"), this.authorizationProperties.getDashboardUrl()))
			.toArray(String[]::new);

		String[] permitAllPaths = Stream
			.concat(this.authorizationProperties.getPermitAllPaths().stream(),
					Stream.of(this.authorizationProperties.getDashboardUrl(), dashboard("/**")))
			.toArray(String[]::new);
		...
		http
			...
			.defaultAuthenticationEntryPointFor(
					...
					new MediaTypeRequestMatcher(new BrowserDetectingContentNegotiationStrategy(), MediaType.TEXT_HTML))
