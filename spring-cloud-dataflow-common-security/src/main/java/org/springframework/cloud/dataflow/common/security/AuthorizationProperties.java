...
public class AuthorizationProperties {
	...
	private Map<String, AuthoritiesMappings> grantedAuthoritiesMappings = new HashMap<>();

	public Map<String, ProviderRoleMapping> getProviderRoleMappings() {
		return providerRoleMappings;
	}

	public Map<String, AuthoritiesMappings> getGrantedAuthoritiesMappings() {
		return grantedAuthoritiesMappings;
	}

	public static class AuthoritiesMappings {
		private Map<String, String> authoritiesMappings = new HashMap<>();

		public Map<String, String> getAuthoritiesMappings() {
			return authoritiesMappings;
		}

		public void setAuthoritiesMappings(Map<String, String> authoritiesMappings) {
			this.authoritiesMappings = authoritiesMappings;
		}
	}
